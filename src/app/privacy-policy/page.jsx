          ...
          <div className="bg-white shadow-md rounded-lg p-6 space-y-8">
            ...
            <section>
              ...
              <ul className="list-decimal list-inside text-gray-600 mt-4 space-y-2">
                ...
                <li>
                  Personalization through tailored recommendations and
                  promotions.
                </li>
            ...
            <section>
              ...
              <p className="text-gray-600 mt-4">
                We retain data as long as necessary to provide services or
                comply with legal obligations. You can request data deletion
                through support.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 mt-4">
                We use encryption, regular updates, and access controls to
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-600 mt-4 space-y-2">
                ...
                <li>
                  Request a copy of your data or withdraw consent for
                  processing.
                </li>
              </ul>
            </section>
