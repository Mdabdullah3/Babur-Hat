      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Ready How is the first and only fashion-focused e-commerce platform
            in Bangladesh, bringing together the best of Bangladeshi fashion
            under one roof. Whether youre looking for trendy apparel, stylish
            accessories, or timeless traditional wear, we are your go-to
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white shadow-lg p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Established Stores</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white shadow-lg p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Online-Only Brands</h3>
              <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <ul className="space-y-4 text-gray-600 max-w-2xl mx-auto">
            <li>
              ...
              All prominent Bangladeshi fashion brands, available in one place.
            </li>
            <li>
            ...
            <li>
              <span className="font-semibold">Affordability:</span> Competitive
              pricing with exclusive discounts and promotions.
            </li>
            <li>
              <span className="font-semibold">Global Reach:</span> We bring
              Bangladeshi fashion to customers worldwide, ensuring high-quality
              garments at affordable prices.
            </li>
          </ul>
        </div>
      </section>
